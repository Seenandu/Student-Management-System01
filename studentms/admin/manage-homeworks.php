...
$sql="SELECT tblclass.ID,tblclass.ClassName,tblhomework.homeworkTitle,tblhomework.postingDate,tblhomework.lastDateofSubmission,tblhomework.id as hwid from tblhomework join tblclass on tblclass.ID=tblhomework.classId LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
