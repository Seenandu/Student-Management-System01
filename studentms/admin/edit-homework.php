...
<?php $hwid=intval($_GET['hwid']);
  $sql="SELECT tblclass.ID,tblclass.ClassName,tblhomework.homeworkTitle,tblhomework.postingDate,tblhomework.lastDateofSubmission,tblhomework.id as hwid,homeworkDescription,lastDateofSubmission from tblhomework join tblclass on tblclass.ID=tblhomework.classId where tblhomework.id=:hwid";
$query = $dbh -> prepare($sql);
$query->bindParam(':hwid',$hwid,PDO::PARAM_STR);
$query->execute();
